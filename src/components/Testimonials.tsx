  ...
  return (
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16">
          <p className="text-muted-foreground mb-8 text-center">{currentContent.recognizedBy}</p>
          <div className="flex flex-wrap justify-center items-center gap-12 max-w-4xl mx-auto">
            <div className="flex flex-col items-center space-y-2">
              <div className="w-24 h-16 bg-muted/30 rounded-lg flex items-center justify-center">
                <span className="text-xs font-medium text-center px-2">Startupbootcamp Australia</span>
              </div>
            </div>
            <div className="flex flex-col items-center space-y-2">
              <div className="w-24 h-16 bg-muted/30 rounded-lg flex items-center justify-center">
                <span className="text-xs font-medium text-center px-2">FLII</span>
              </div>
            </div>
            <div className="flex flex-col items-center space-y-2">
              <div className="w-24 h-16 bg-muted/30 rounded-lg flex items-center justify-center">
                <span className="text-xs font-medium text-center px-2">Alterna Accelerator</span>
              </div>
            </div>
            <div className="flex flex-col items-center space-y-2">
              <div className="w-24 h-16 bg-muted/30 rounded-lg flex items-center justify-center">
                <span className="text-xs font-medium text-center px-2">Fermentasmania</span>
              </div>
            </div>
          </div>
        </div>
