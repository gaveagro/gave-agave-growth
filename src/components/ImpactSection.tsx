      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Measurable Impact, Sustainable Returns
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Every investment creates positive environmental and social impact while delivering superior financial returns through our technology-driven approach.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Real-time monitoring of plant health, soil conditions, and growth patterns using IoT sensors and satellite imagery.</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-primary rounded-full mt-2"></div>
          ...
          <div className="bg-gradient-impact rounded-lg p-8 text-white">
            <h3 className="text-2xl font-bold mb-6">Superior Returns</h3>
            <div className="space-y-6">
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-2xl font-bold">8-12 Years</span>
                </div>
                <div className="bg-white/20 rounded-full h-2">
