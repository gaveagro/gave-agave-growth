...
const ImpactSection = () => {
  ...
  const content = {
    EN: {
      ...
      additionalMetrics: [{
        title: 'Indigenous Land Ownership',
        value: '100%'
      }, {
        title: 'Agave Species Germination',
        value: '10'
      }, {
    ...
    ES: {
      ...
      additionalMetrics: [{
        title: 'Propiedad de Tierra Indígena',
        value: '100%'
      }, {
        title: 'Germinación de Especies de Agave',
        value: '10'
      }, {
  ...
  return <section id="impact" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {currentContent.impactAreas.map((area, index) => <Card key={index} className="text-center hover:shadow-lg transition-shadow">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          {currentContent.additionalMetrics.map((metric, index) => <Card key={index} className="text-center">
